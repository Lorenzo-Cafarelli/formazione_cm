...
Alpine Linux, essendo estremamente minimale, ha richiesto passaggi aggiuntivi rispetto a Ubuntu. È stato necessario installare il pacchetto shadow per la gestione degli utenti e generare esplicitamente le host keys SSH (ssh-keygen -A) che, a differenza di Ubuntu, non vengono create automaticamente all'installazione del pacchetto openssh.
